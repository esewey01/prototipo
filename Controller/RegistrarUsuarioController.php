...
require('Constants.php');
    ...
    class UserRegistrationController
    {
        ...
        private function validatePhoneNumber($phone)
        {
            ...
            $access_key = "def606ef1f48402d68e7c5cd53e8babf";
            $country_code = "MX";
            $format = 1;
            ...
            if (strlen($phone) > 11) {
                $this->errors[] = "El teléfono no puede exceder los 15 caracteres";
                return;
            }
        ...
        private function processPhotoUpload(&$userData)
        {
            ...
            $$uploadDir = __DIR__ . '/fotoproducto/'; // Apuntará a /Views/fotoproducto/
            $filename = uniqid() . '.' . $extension;
            $userData['fotoPath'] = 'fotoproducto/' . $filename; // Guarda esto en DB
            
            // Mueve el archivo
            if (!move_uploaded_file($foto['tmp_name'], $uploadDir . $filename)) {
                error_log("Error moviendo archivo: " . print_r(error_get_last(), true));
        ...
        private function showMessages($isSuccess)
        {
            ...
            $redirectUrl = $isSuccess ? '../index.php' : '../Views/RegistrarUsuarioView.php';
