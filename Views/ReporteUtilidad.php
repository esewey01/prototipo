...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Text(20, 14, 'Historial de utilidad Ventas', 0, 'C', 0);
        $this->Ln(10);
    }
    ...
    function Footer()
    {
        ...
        $this->Cell(100, 10, 'Datos Generados por iCont', 0, 0, 'L');
...
$pdf->Ln(5);
$pdf->Cell(0, 6, 'TOTAL VENDIDO (+):  ' .  $totalVendido, 0, 1);
$pdf->Ln(5);
$pdf->Cell(0, 6, 'UTILIDAD NETA = (INGRESO - GASTOS) :  ' .  $utilidadNetaDeLaEmpresa, 0, 1);
