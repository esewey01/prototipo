    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <span class="text-muted">Stock: <?= $producto['cantidad'] ?></span>
                <span class="ml-auto h4 text-primary">$<?= number_format($producto['precio_venta'], 2) ?></span>
            </div>
            
            <div class="mb-4">
                <h5 class="d-inline-block">Vendedor:</h5>
                <span class="badge bg-info ml-2"><?= htmlspecialchars($producto['nombre_vendedor']) ?></span>
